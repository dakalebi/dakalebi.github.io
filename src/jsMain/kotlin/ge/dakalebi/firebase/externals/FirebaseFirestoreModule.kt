...
/**
 * Live document listener. Returns the unsubscribe function — declared as a
 * plain `() -> Unit` rather than the `Unsubscribe` marker interface, because
 * this one actually has to be called when the user signs out.
 */
